...
### Version 1.5.0 – Stand: 30. Oktober 2025
...
* Micronaut 4.x (Backend)
* Java 21 / Kotlin
* Docker + DevContainer
* OpenTelemetry SDK + Collector
* Keycloak 23+
* GitHub Actions / Jenkins
* BPMN-Engines: Camunda 7.x (REST-basiert) und Camunda 8.x/Zeebe (gRPC-basiert), Flowable 6.x, Activiti 7.x, Imixs 6.x
...
© 2025 x-wal Project Team – Version 1.5.0
