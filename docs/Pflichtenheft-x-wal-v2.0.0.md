...
**Implementierungsstand:** Hexagonale Architektur vollstaendig umgesetzt. 11 von 12 Muss-Anforderungen implementiert (1 Teilziel).
...
| 2 | E2E Urlaubsantrag-Test | Erledigt | Done |
| 3 | Helm Chart | Post-MVP | Offen |
| 3 | OpenAPI Spec Generation + Swagger UI | Post-MVP | Done |
